...
export const COMPREHENSIVE_GENERIC_DRUGS: DrugItem[] = [
  ...
  { id: 'g6', genericName: 'Mefenamic Acid', category: 'adult', dosage: '500mg (1-0-1 after food)', duration: '3 days', minAge: 12, minWeight: 40 },
  { id: 'g7', genericName: 'Tramadol + Paracetamol', category: 'adult', dosage: '37.5mg/325mg (1-0-1 S.O.S)', duration: '3 days', minAge: 18, minWeight: 40 },

  // Antibiotics & Antimicrobials
  { id: 'g8', genericName: 'Amoxicillin', category: 'adult', dosage: '500mg (1-0-1 after food)', duration: '5 days', minAge: 12, minWeight: 40 },
  ...
  { id: 'g10', genericName: 'Amoxicillin + Clavulanic Acid (Augmentin)', category: 'adult', dosage: '625mg (1-0-1 after food)', duration: '5 days', minAge: 12, minWeight: 40 },
  ...
  { id: 'g12', genericName: 'Azithromycin', category: 'adult', dosage: '500mg (1-0-0 1 hr before food)', duration: '3 days', minAge: 12, minWeight: 40 },
  ...
  { id: 'g14', genericName: 'Ciprofloxacin', category: 'adult', dosage: '500mg (1-0-1 after food)', duration: '5 days', minAge: 18, minWeight: 40 },
  { id: 'g15', genericName: 'Levofloxacin', category: 'adult', dosage: '500mg (1-0-0 once daily)', duration: '5 days', minAge: 18, minWeight: 40 },
  { id: 'g16', genericName: 'Cefixime', category: 'adult', dosage: '200mg (1-0-1 after food)', duration: '5 days', minAge: 12, minWeight: 40 },
  { id: 'g17', genericName: 'Cefixime (Syrup 50mg/5ml)', category: 'pediatric', dosage: '5ml (b.d.)', duration: '5 days', minAge: 1, maxAge: 12 },
  { id: 'g18', genericName: 'Metronidazole', category: 'adult', dosage: '400mg (1-1-1 after food)', duration: '5 days', minAge: 12, minWeight: 40 },
  ...
  { id: 'g20', genericName: 'Pantoprazole', category: 'adult', dosage: '40mg (1-0-0 30 mins before breakfast)', duration: '7 days', minAge: 12, minWeight: 40 },
  { id: 'g21', genericName: 'Omeprazole', category: 'adult', dosage: '20mg (1-0-0 before food)', duration: '7 days', minAge: 12, minWeight: 40 },
  { id: 'g22', genericName: 'Rabeprazole + Domperidone', category: 'adult', dosage: '20mg/30mg SR (1-0-0 before food)', duration: '7 days', minAge: 18, minWeight: 40 },
  ...
  { id: 'g26', genericName: 'Dicyclomine + Paracetamol', category: 'adult', dosage: '20mg/500mg (1-0-1 S.O.S for spasms)', duration: '3 days', minAge: 12, minWeight: 40 },
  ...
  { id: 'g34', genericName: 'Metformin', category: 'adult', dosage: '500mg (1-0-1 after food)', duration: '30 days', minAge: 18, minWeight: 40 },
  { id: 'g35', genericName: 'Glimepiride', category: 'adult', dosage: '1mg (1-0-0 before breakfast)', duration: '30 days', minAge: 18, minWeight: 40 },
  { id: 'g36', genericName: 'Telmisartan', category: 'adult', dosage: '40mg (1-0-0 morning)', duration: '30 days', minAge: 18, minWeight: 40 },
  { id: 'g37', genericName: 'Amlodipine', category: 'adult', dosage: '5mg (0-0-1 night)', duration: '30 days', minAge: 18, minWeight: 40 },
  { id: 'g38', genericName: 'Atorvastatin', category: 'adult', dosage: '10mg (0-0-1 at night)', duration: '30 days', minAge: 18, minWeight: 40 },
  ...
  { id: 'g42', genericName: 'Methylcobalamin (Vitamin B12)', category: 'adult', dosage: '1500mcg (1-0-0 once daily)', duration: '30 days', minAge: 12, minWeight: 40 },
